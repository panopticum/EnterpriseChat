...
import main.repository.MessageReporitory;
...
public class ChatController {
    ...
    public HashMap<String, List<MessageResponse>> getMessages() {
        ArrayList<MessageResponse> messagesList = new ArrayList<>();
        Iterable<Message> messages = messageReporitory.findAll();
        ...
        HashMap<String, List<MessageResponse>> response = new HashMap<>();
    ...
    public AddMessageResponse addMessage (HttpServletRequest request) {
        ...
        messageReporitory.save(message);
    ...
    public HashMap<String, List<UserResponse>> getUsers() {
        ...
        HashMap<String, List<UserResponse>> response = new HashMap<>();
